...
// 1. Conexión y forzado de UTF-8 para los emojis
$conn = conectar(); // Usamos tu función que ya debería tener $conn->set_charset("utf8mb4");

// 2. Limpiar la tabla
$conn->query("TRUNCATE TABLE alumnos");

// 3. Preparar el Gran INSERT
...
if ($conn->query($sql) === TRUE) {
    echo "<h1>Hecho!</h1><p>Tabla vaciada y vuelta a rellenar con alumnos mágicos insertados correctamente.</p>";
} else {
